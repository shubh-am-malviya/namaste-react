...
const Header = () => {
	return <header className="header">
		<div className="logo-container">
			<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVermuyA5zuSvADyNPet-giCboNoUHK52G9w&usqp=CAU" alt="Logo" className="logo" />
		</div>
...
const RestaurantCard = (props) => {
	...
	return <div className="res-card">
        <img src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId} alt="res-logo" className="res-logo" />
		<h3>{name}</h3>
		<h3>{cuisines?.join(", ")}</h3>
